...
const colors = [
  { accent: '#ff8b80', bgGradient: 'linear-gradient(135deg, #ffffff, #fffcfc)', overlay: 'rgba(255, 139, 128, 0.08)' }, // Muted Coral
  { accent: '#7fa37f', bgGradient: 'linear-gradient(135deg, #ffffff, #fcfdfc)', overlay: 'rgba(127, 163, 127, 0.08)' }, // Sage Green
  { accent: '#9b8fc7', bgGradient: 'linear-gradient(135deg, #ffffff, #fcfbfe)', overlay: 'rgba(155, 143, 199, 0.08)' }, // Lavender Gray
  { accent: '#d98c5f', bgGradient: 'linear-gradient(135deg, #ffffff, #fffdfc)', overlay: 'rgba(217, 140, 95, 0.08)' }, // Burnt Orange
  { accent: '#4f5d75', bgGradient: 'linear-gradient(135deg, #ffffff, #fbfcfd)', overlay: 'rgba(79, 93, 117, 0.08)' }, // Deep Slate
  { accent: '#7ce0b8', bgGradient: 'linear-gradient(135deg, #ffffff, #fbfefe)', overlay: 'rgba(124, 224, 184, 0.08)' }  // Soft Mint
];
