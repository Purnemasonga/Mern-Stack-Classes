    ...
    >
      ...
      >
        <div className="bg-premium-charcoal/80 backdrop-blur-2xl rounded-4xl p-10 shadow-cinematic border border-white/10 relative overflow-hidden group">
          ...
          <div className="absolute -top-24 -right-24 w-48 h-48 bg-premium-cyan/10 rounded-full blur-3xl pointer-events-none"></div>
          <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-premium-coral/10 rounded-full blur-3xl pointer-events-none"></div>

          <div className="text-center mb-10 relative z-10">
            <h2 className="text-3xl font-display font-bold text-premium-cream">Join the Arena</h2>
            <p className="mt-2 text-premium-slate font-medium">Create your competitive profile</p>
          </div>
          ...
          <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
            <div className="space-y-5">
              <div className="relative">
                <User className={`absolute left-5 top-1/2 -translate-y-1/2 transition-colors ${focusedInput === 'username' ? 'text-premium-cream' : 'text-premium-slate'}`} size={20} />
                <input
                  type="text"
                  required
                  className={`w-full bg-premium-black/50 border rounded-2xl px-5 pl-14 py-4 text-premium-cream placeholder-premium-slate transition-all outline-none focus:bg-premium-black shadow-inner ${focusedInput === 'username' ? 'border-premium-yellow/50 shadow-[0_0_15px_rgba(245,176,65,0.15)]' : 'border-white/10 hover:border-white/20'}`}
          ...
          <div className="text-center mt-8 relative z-10">
            <p className="text-premium-slate font-medium">
              Already a player?{' '}
              <Link to="/login" className="text-premium-cream hover:text-premium-yellow transition-colors font-bold underline decoration-white/20 underline-offset-4 hover:decoration-premium-yellow">
                Sign in here
              </Link>
            </p>
          </div>
